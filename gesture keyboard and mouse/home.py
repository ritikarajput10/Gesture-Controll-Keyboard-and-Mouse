...
lbl = tk.Label(root, text="Welcome to virtual mouse and keyboard", font=('Lucida Sans Unicode', 40,' bold ',), height=1, width=50,bg="#8B0A50",fg="white")
lbl.place(x=0, y=3)
